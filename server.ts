...
Quand un outil retourne Résultats (base toi UNIQUEMENT dessus), cite le résultat EXACT sans inventer. Exemple: si take_screenshot retourne "Capture d'écran enregistrée et ouverte : Capture d'écran 2026-...png", tu réponds "C'est fait. Capture enregistrée et ouverte : Capture d'écran 2026-...png" et tu n'ajoutes JAMAIS "je n'ai pas de fichier".
