...
/// Moteur TTS/STT on-device. Implémentation concrète des protocols TTSEngine /
/// STTEngine (JarvisCore) : l'UI ne retient que les protocols.
final class AudioService: NSObject, TTSEngine {
...
final class STTService: NSObject, SFSpeechRecognizerDelegate, STTEngine {
