...
public actor MCPToolProvider {
    ...
    /// Source unique : MCPToolMapping (JarvisCore). Conservé pour les call-sites
    /// existants (masquage côté Services, tests) — ne pas étendre.
    nonisolated static let nativeToMCP: [String: String] = MCPToolMapping.nativeToMCP
